                        ...
                        <div class="">
                          <div class="fadeIn animated mb-4">
                                <div class="text-capitalize">
                                  <h2 align="center" class="text-capitalize">Sistem Informasi Surat Menyurat Satu Pintu <br>MAN 2 Pekanbaru </h2>
                                    
                                    <div class=""><div><center><img src="assets/images/logo.png" width="150" height="160" /></center></div>
                        <div><br>
                        Selamat datang di Sistem Informasi Surat Menyurat satu Pintu MAN 2 Pekanbaru. Sistem ini merupakan sistem yang digunakan untuk mengelola surat masuk dan surat keluar dan disertai dengan bukti upload berkas</div>
                    </div>
                              </div>
                            </div>
                        </div>
